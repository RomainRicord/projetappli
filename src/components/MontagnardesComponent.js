import montagnardes from '../data/montagnarde.js';

import {View,ScrollView} from 'react-native'

import CardPizza from './CardPizza.js';

const MontagnardesComponent = (props) => {
    ...
    <ScrollView style={{flex:1}}>
        ...
        <View style={{display:'flex',flexDirection:'column'}}>
            ...
            {montagnardes.map((e,k) => {

                if (k < Math.ceil(montagnardes.length/2)) {
...
export default MontagnardesComponent